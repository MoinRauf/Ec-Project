...
export const customer = [
  {
    id: 1,
    desc: "Explore our dedicated e-commerce hub where quality meets creativity. We specialize in a wide range of digital resources—from web themes and UI designs to 3D models, image stocks, and mockup designs—crafted to elevate your projects with ease.",
    // name: "ALGISTINO",
    // post: "Marketing Company Director",
  },
  {
    id: 2,
    desc: "Choose from our curated collection where each digital asset exceeds industry standards, enhancing your creative ventures. Enjoy secure Firebase authentication and Stripe payment processing for safe transactions, ensuring a seamless shopping experience.",
    // name: "ALGISTINO",
    // post: "Marketing Company Director",
  },
  {
    id: 3,
    desc: "At the core of our platform lies a dedication to continuous improvement and innovation. We're committed to expanding our offerings to better serve you, supported by exceptional customer care. Thank you for trusting us as your go-to source for premium digital assets, empowering your creative pursuits.",
    // name: "ALGISTINO",
    // post: "Marketing Company Director",
  },
];
